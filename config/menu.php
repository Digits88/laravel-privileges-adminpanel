...
//        ->url('http://www.google.com', 'Google')
        ->add(Menu::adminlteSeparator('PRIVILEGE'))
        ->routeIfCan('browse permissions', 'permissions', '<i class="fa fa-key"></i> <span>Permissions</span>')
        ->routeIfCan('browse roles', 'roles', '<i class="fa fa-id-card"></i> <span>Roles</span>')
        ->routeIfCan('browse users', 'users', '<i class="fa fa-users"></i> <span>Users</span>')
        #adminlte_menu
